...
describe(Patron) do
  ...
  describe "#save" do
    it("adds a patron to database of saved patrons") do
      test_patron = Patron.new({:name => "Fred", :book_history => "Don Quixote", :current_books => "The Hobbit", :due_date => "2017-05-10", :book_id => 1, :id => 1})
      test_patron.save()
  ...
  describe '#==' do
    it 'is the same patron if it has the same description and list ID' do
      patron1 = Patron.new({:name => "Fred", :book_history => "Don Quixote", :current_books => "The Hobbit", :due_date => "2017-05-10", :book_id => 1, :id => 1})
      patron2 = Patron.new({:name => "Fred", :book_history => "Don Quixote", :current_books => "The Hobbit", :due_date => "2017-05-10", :book_id => 1, :id => 1})
