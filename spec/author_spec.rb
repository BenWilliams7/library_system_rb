...
describe(Author) do
  ...
  describe "#save" do
    it("adds a author to the array of saved authors") do
      test_author = Author.new({:name => "Tolkien", :books => "The Hobbit", :id => 1})
      test_author.save()
  ...
  describe '#==' do
    it 'is the same author if it has the same description and list ID' do
      author1 = Author.new({:name => "Tolkien", :books => "The Hobbit", :id => 1})
      author2 = Author.new({:name => "Tolkien", :books => "Tolkien", :id => 1})
